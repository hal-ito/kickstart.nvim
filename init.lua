...
require('lazy').setup({
...

  {
    ...
    keys = {
      { '<C-k>', '<cmd>HopWord<CR>', mode = { 'n', 'v' }, desc = 'Hop Word' },
      { '<C-j>', '<cmd>HopLine<CR>', mode = { 'n', 'v' }, desc = 'Hop Line' },
      { 's', '<cmd>HopChar2AC<CR>', mode = { 'n', 'v' }, desc = 'Hop 2Char' },
      { 'S', '<cmd>HopChar2BC<CR>', mode = { 'n', 'v' }, desc = 'Hop 2Char' },
